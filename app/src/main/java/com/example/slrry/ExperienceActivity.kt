        ...
        setContent {
            SLRRYTheme {
                Surface(modifier = Modifier.fillMaxSize()) {
                    ...
                    ExperienceScreen(
                        selectedExperience = onboardingViewModel.experience.value
                            ?: "Beginner (Just starting out)",
                        step = 4,
                        totalSteps = onboardingViewModel.totalSteps,
                        onExperienceSelected = { onboardingViewModel.experience.value = it },
                        onBack = {
                        ...
                        onNext = {
                            ...
                            startActivity(
                                Intent(
                                    ...
                                    DistanceGoalActivity::class.java
                                )
                            )
                        }
                    )
...
fun ExperienceScreen(
    ...
    val options = listOf(
        "Beginner (Just starting out)",
        "Intermediate (Run occasionally)",
        "Advanced (Run regularly)"
    )
    ...
    Column(
        ...
        options.forEachIndexed { index, option ->
            ExperienceOptionRow(
                ...
                onSelect = { onExperienceSelected(option) }
            )
...
@Composable
private fun ExperienceOptionRow(
    label: String,
    selected: Boolean,
    onSelect: () -> Unit
) {
...
private fun ExperiencePreview() {
    SLRRYTheme {
        ExperienceScreen(
            selectedExperience = "Beginner (Just starting out)",
            step = 4,
            totalSteps = 7,
